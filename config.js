...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+94728356328, // Mettez votre numéro ici
    BOT_NAME: "AKIYA MD Mini",
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://whatsapp.com/channel/0029Vb8QaJD0Qear0HQEA60Q',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: '20260715_162415.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb8QaJD0Qear0HQEA60Q',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '7214172448:AAHGqSgaw-zGVPZWvl8msDOVDhln-9kExas',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '+94728356328'
